...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_model_unzip.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u89e3\u538b\u538b\u7f29\u5305\u5230\u5f53\u524d\u6587\u4ef6\u6240\u5728\u76ee\u5f55</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_model_unzip.setText(QCoreApplication.translate("MainWindow", u"\u89e3\u538b\u6a21\u5f0f", None))
#if QT_CONFIG(tooltip)
        self.checkBox_model_test.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u4ec5\u641c\u7d22\u538b\u7f29\u5305\u7684\u5bc6\u7801\u800c\u4e0d\u8fdb\u884c\u89e3\u538b\uff0c\u7ed3\u679c\u663e\u793a\u5728\u201c\u5386\u53f2\u8bb0\u5f55\u201d\u9875</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_model_test.setText(QCoreApplication.translate("MainWindow", u"\u6d4b\u8bd5\u6a21\u5f0f", None))
#if QT_CONFIG(tooltip)
        self.checkBox_delect_zip.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u89e3\u538b\u5b8c\u6210\u540e\u5220\u9664\u539f\u6587\u4ef6\uff08\u5230\u56de\u6536\u7ad9\uff09</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_delect_zip.setText(QCoreApplication.translate("MainWindow", u"\u5220\u9664\u539f\u6587\u4ef6", None))
#if QT_CONFIG(tooltip)
        self.checkBox_nested_folders.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u903b\u8f91\u7c7b\u4f3c\u4e8eBandzip</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_nested_folders.setText(QCoreApplication.translate("MainWindow", u"\u5904\u7406\u5957\u5a03\u6587\u4ef6\u5939", None))
#if QT_CONFIG(tooltip)
        self.checkBox_nested_zip.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u903b\u8f91\u4e3a\uff1a\u5c06\u89e3\u538b\u540e\u7684\u6587\u4ef6\u91cd\u65b0\u8fd0\u884c\u4e00\u6b21\u89e3\u538b</p><p><br/></p><p>\u5efa\u8bae\u4e0e\u201c<span style=\" font-weight:600;\">\u4ec5\u89e3\u538b\u538b\u7f29\u5305</span>\u201d\u9009\u9879\u540c\u65f6\u9009\u4e2d</p><p><br/></p><p>\u7528\u4e8e\u89e3\u538b\u3010<span style=\" font-weight:600;\">\u6e38\u620f\u3001\u590d\u6742\u7ed3\u6784\u6587\u4ef6</span>\u3011\u65f6\u4e0d\u5efa\u8bae\u4f7f\u7528</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
